...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 pb-10  px-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="w-full">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-xl font-semibold text-white font-poppins">
                  Follow Us On
                </h4>
                <div className="mb-6 flex items-center">
                  <a
                    href="javascript:void(0)"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full  sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#ad4b4b" stopOpacity="0.31" />
                  <stop offset={1} stopColor="#C4C4C4" stopOpacity={0} />
                </linearGradient>
              </defs>
            </svg>
    ...
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          ...
          <ul className="space-y-3 font-delius text-white">{children}</ul>
        </div>
      </div>
    </>
  );
