...
export default function Navbar() {
  ...
  return (
    <>
      <div className="w-full h-20 bg-bg-gradientVioletNav px-3 ssm:h-12 lg:h-20">
        <div className="w-full h-full flex items-center justify-between">
          <div className="h-full flex items-center w-96 lg:justify-end">
            <span className="text-4xl font-poppins text-white tracking-wider ssm:text-2xl lg:text-4xl">
          ...
          <div className="w-20 h-full px-3 py-4 cursor-pointer ssm:py-1 lg:py-4" onClick={()=>setShow(!show)}>
