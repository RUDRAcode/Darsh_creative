...
const Service = () => {
  return (
    <section className="pb-12 pt-16 relative dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              <span className="mb-2 block text-3xl font-semibold text-violet-600">
                Our Services
              </span>
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-bg-gradientViolet p-10 shadow-2 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-3  md:px-7 xl:px-10">
          <div className="mb-8 flex h-[70px] bg-blue-600 w-[70px] items-center justify-center rounded-2xl p-4">
            {icon}
          </div>
          <h4 className="mb-[14px] text-2xl font-semibold text-white font-delius">
            {title}
          </h4>
          <p className="text-white font-roboto">{details}</p>
        </div>
      </div>
    </>
  );
